        ...
        <div className="form">
            ...
            <form onSubmit={onSubmitHandler}>
                <div className="form__group">
                    <label>Имя пользователя: <input className="form__control"
                        type="username"
                        id="username"
                        name="username"
                ...
                <div className="form__group">
                    <label>Email: <input className="form__control"
                        type="email"
                        id="email"
                        name="email"
                ...
                <div className="form__group">
                    <label>Пароль: <input className="form__control"
                        type="password"
                        id="password"
                        name="password"
                ...
                <div className="form__group">
                    <label>Повторите пароль: <input className="form__control"
                        type="password"
                        id="password2"
                        name="password2"
